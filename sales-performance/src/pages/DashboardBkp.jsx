...
// Helper function for FYI
const pad2 = (n) => String(n).padStart(2, "0");

// Current date ke basis pe default FY choose karega
const getDefaultFY = () => {
  const now = new Date();
...
export default function Dashboard() {
  const role = localStorage.getItem("role"); // EMPLOYEE | TL | ADMIN
  ...
  // 🔥 EMPLOYEE TARGET ADJUST BASED ON RANGE
