...
const filteredPurchases = purchases.filter((purchase) => {
  ...
  const vendorMatch = purchase.vendorName
    ?.toLowerCase()
    .includes(searchText);
...
<div className="space-y-6">
  ...
  <tr>
    ...
    <th className="border px-4 py-3 text-center">Duration</th>
    ...
    <th className="border px-4 py-3 text-center">Price</th>
    <th className="border px-4 py-3 text-center">Discount</th>
